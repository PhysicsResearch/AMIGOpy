...
def set_vtk_histogran_fig(self): 
    ...
    if hasattr(self, 'fig_Hist_01') and self.fig_Hist_01:
        plt.close(self.fig_Hist_01)  # Close the previous figure to release memory
    
    # Check if previous canvas exists, and delete it
    if hasattr(self, 'canvas_Hist_01') and self.canvas_Hist_01:
        self.canvas_Hist_01.deleteLater()  # Delete the previous canvas
    
    # Check if previous toolbar exists, and delete it
    if hasattr(self, 'toolbar_Hist_01') and self.toolbar_Hist_01:
        self.toolbar_Hist_01.deleteLater()  # Delete the previous toolbar
    
    # Prepare the data based on the selected DataType
    ...
    # Set axes and labels color to white
    ...
    self.toolbar_Hist_01 = NavigationToolbar(self.canvas_Hist_01, self)  # Create new toolbar
    ...
    self.hist_container_01.layout().addWidget(self.toolbar_Hist_01)
